"""
Script to update gemini.py with narrator mode support
Run this script to automatically update the break_story_into_scenes function
"""

import re

# Read the current gemini.py file
...
new_function = '''    async def break_story_into_scenes(
        self, 
        story_text: str, 
...
# Pattern to match the entire function from definition to the next function
pattern = r'(    async def break_story_into_scenes\([\s\S]*?)(    async def generate_talking_character_prompt)'
...
print("✅ Successfully updated gemini.py with narrator mode support!")
print("📝 Updated break_story_into_scenes function")
print("🎙️ Added support for 3 narrator modes:")
print("   - narrator_with_visuals")
print("   - narrator_only")
print("   - none")
